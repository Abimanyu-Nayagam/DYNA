...
const CsgoPlayersPage = () => {
  ...
  const handleCreatePortfolio = () => {
    if (!user) {
      ...
      navigate("/players/csgo/create");
    }
  };

  return (
    <div className="players-page-csgo">
      <div className="players-header">
        <div className="header-content">
          <h1 className="page-title">CSGO PLAYERS</h1>
        </div>
      </div>
              ...
              <div className="players-grid">
                {filteredPlayers.map((player) => (
                  <PlayerCard
                    ...
                    onClick={() => navigate(`/players/${player.username}/csgo`)}
                  />
                ))}
              </div>
            </>
...
export default CsgoPlayersPage;
